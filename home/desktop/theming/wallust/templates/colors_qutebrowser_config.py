...
# Scheme name: Custom
# Scheme author: Wallust
# Template author: Skyler
...
c.colors.completion.category.border.bottom = foreground
...
c.colors.contextmenu.disabled.fg = base00
...
c.colors.contextmenu.selected.bg = base00
...
c.colors.downloads.start.fg = base0E
...
# Sets border size and color for hint
c.hints.border = f"1px solid {foreground}" 
